...
<div id="gallery" class="section wb">
    <div class="container">
        ...
        <div style="text-align: center;">
            ...
            try {
                $response = $api->paymentRequestStatus($pid);
...
//echo "</pre>";
        ...
        <div id="da-thumbs" class="da-thumbs portfolio">
            <?php
            // Data Fetch
            $r_name = $_SESSION['rname'];
            $book = $_SESSION['bookdate'];
            $ocupants = $_SESSION['person'];

            // Queries
            $Insert_Payment_Sql = "INSERT INTO payment(R_name,R_price,Email,Payment_id,Book_date,) VALUES ('$r_name','$amount','$email','$payment_id','$book')";
            echo $Insert_Payment_Sql;
            $Insert_Booking_Sql = "INSERT INTO book_resource(R_name,R_occupants,Email,R_price,Payment_id,R_bookdate) VALUES ('$r_name','$ocupants','$email','$amount','$payment_id','$book')";
            echo $Insert_Payment_Sql;
