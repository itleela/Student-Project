			...
			$result = mysqli_num_rows($data);
				...
				<div class="col-md-4 col-sm-4 col-sm-12">
					...
					<div class="single-services">
						...
						<a class="btn btn-light btn-radius grd1 btn-brd"  href='bookout1.php?<?php echo"res_id=$row[id]"; ?>'> Book </a>
                          <!-- <button type="button" class="btn btn-light btn-radius grd1 btn-brd" data-toggle="modal" data-target="#myModal">Book</button> -->
                          <!-- The Modal -->
